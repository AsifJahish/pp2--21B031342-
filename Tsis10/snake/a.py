...
def run_game(username):
    ...
    class Wall:
      ...
      def load_wall(self):
        with open(f'/home/asifjahish/vscode/pp2--21B031342-/Tsis10/snake/level1.txt', 'r') as f:
    ...
    while running:
        ...
        wallsCoor = open(f"/home/asifjahish/vscode/pp2--21B031342-/Tsis10/snake/level1.txt", 'r').readlines()
        walls = []
